...
Камера телефона может потребовать HTTPS. Если браузер не разрешит доступ к камере по `http://SERVER_IP:8081`, используйте ручной ввод QR или подключите домен с HTTPS.
